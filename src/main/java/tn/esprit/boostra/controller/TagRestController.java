...
public class TagRestController {
  ...
  //
  //	public void AddTagToPost( @RequestParam ("tagId") long tagId,
  //@RequestParam ("postId") long postId) { 		ts.AddTagToPost(tagId, postId);
  //
  //	}

  @PostMapping("/tag/AddTagToPost")
  public void AddTagAffectToPost(@RequestBody List<Tag> tags,
