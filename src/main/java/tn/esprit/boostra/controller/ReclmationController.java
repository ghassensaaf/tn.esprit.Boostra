...
public class ReclmationController {
	...
	public Reclamation UpadateReclamation(@RequestParam("ReclmationId") Long ReclmationId,@RequestBody Reclamation reclamation)
	{
	...
	public void DeleteReclamation(@PathVariable("ReclamationId") Long ReclamationId)
	{
