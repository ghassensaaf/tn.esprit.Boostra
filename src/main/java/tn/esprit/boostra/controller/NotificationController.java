...
public class NotificationController {
  @Autowired INotificationService inotificationservice;
  ...
  @ResponseBody
  public Notification
  getNotificationById(@PathVariable("idNotification") Long idNotification) {
  ...
  @ResponseBody
  public void
  deleteNotificationById(@PathVariable("idNotification") Long idNotification) {
  ...
  public void CheckEventsToday() {
    ...
    for (Event event : lst) {
      System.out.println(
          "  You have an event today: " + event.getDescription() + "\n");
    }
  }
