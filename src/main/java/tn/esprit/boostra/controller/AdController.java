...
public class AdController {
  @Autowired IAdService iAdService;
  public AdController() {}
  public AdController(IAdService iAdService) { this.iAdService = iAdService; }
  @PostMapping("/addAd")
  ...
  public List<Ad>
  AdReseaux(@RequestParam("ReseauxSociaux") String ReseauxSociaux) {
  ...
  public void scheduleTaskUsingCronExpression() {
    ...
    for (String string : lst) {
      ...
      for (Ad ad : lstAd) {
        output = output + "     Id: " + ad.getId() +
                 ", Start Date: " + ad.getStartDate() +
                 ", End date: " + ad.getEndDate() +
                 ", Event description: " + ad.getEvent().getDescription() +
                 "\n";
      }
    }
  ...
  public void addAndAssignAd(@RequestBody Ad ad,
