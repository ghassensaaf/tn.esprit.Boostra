...
public class CommentPostRestController {
	...
	IPostService ps;
	@Autowired	
	ICommentPostService cs;
	
	@PostMapping("/PostComment/Add")
	public Comment AddPostComment(@RequestBody Comment comment,@RequestParam("PostId") Long PostId)
	{
	...
	public Comment updateComment(@RequestBody Comment comment , @RequestParam("commentId") long commentId, @RequestParam("postId") long postId) {
