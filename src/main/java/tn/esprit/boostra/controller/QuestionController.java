...
public class QuestionController {
	...
	public Question updateQuestion(@RequestBody Question question,@RequestParam("id") Long id){
	...
	public void addandsignquestion(@RequestBody Question question,@RequestParam("id") Long idQuiz){
