...
public class CommentArticleController {
  ...
  @Autowired ICommentsArticleService Cs;

  @PostMapping("/ArticleComment/Add")
  public Comment AddArticleComment(@RequestBody Comment comment,
  ...
  public Comment
  UpadateArticleComment(@RequestParam("CommentId") Long CommentId,
