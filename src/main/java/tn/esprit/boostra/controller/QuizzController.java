...
public class QuizzController {
  ...
  @Autowired IQuizService quizzService;
  @Autowired IUserService userservice;
  @Autowired INoteService noteService;
  ...
  public String PasserQuiz(@RequestParam("answers") List<String> answers,
                           @RequestParam("id") long id) {
    return quizzService.PasserQuiz(answers, id);
  }
  @GetMapping("/passquizEval")
  public String PassQuizEval(@RequestParam List<String> answers,
                             @RequestParam("quizid") Long id,
