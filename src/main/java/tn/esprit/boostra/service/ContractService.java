...
public class ContractService implements IContractService {
  ...
  @Autowired ContractRepository cr;

  @Autowired PartnerRepository pr;

  @Override
  public Contract addContract(Contract contract, long partnerId)
      throws JSONException, IOException {
    JSONObject json = readJsonFromUrl(
        "https://v6.exchangerate-api.com/v6/49ab5ca8e26fd77d5f131fcd/latest/TND");
  ...
  @Override
  public Contract updateContract(Contract contract, long partnerId)
      throws JSONException, IOException {
    ...
    for (Contract contract : list) {
      ...
      if (contract.isRenewing()) {
        ...
        if (contract.getTypeContract().toString().equals("Monthly")) {
          ...
          msg += "****************************************** \n";
          sendmail(
              "info@boostra.tn", contract.getPartner().getEmail(),
              "Renouvellement  du contrat ",
              "Bonjour cher partenaire \nNous vous informons que votre contrat n° " +
                  contract.getId() +
                  " à bien été renouvelé d'un mois. \nCordialement ");
          ...
          sendmail(
              ...
              "Bonjour cher partenaire \nNous vous informons que votre contrat n° " +
                  contract.getId() +
                  " à bien été renouvelé de 6 mois. \nCordialement");
          ...
          sendmail(
              ...
              "Bonjour cher partenaire \nNous vous informons que votre contrat n° " +
                  contract.getId() +
                  " à bien été renouvelé d'un an. \nCordialement");
        }
      } else {
        contract.setStatut(false);
        msg +=
            "Le Contract N° " + contract.getId() + " est non renouvlable  \n";
